...
OSM_UTILS_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), "osm_utils")

# Ensure these directories are in sys.path
for path in [UTILS_PATH, OSM_UTILS_PATH]:
...
from tools.feature_pipeline import Pipeline
...
@hydra.main(config_path=CONFIG_PATH, config_name="features_config", version_base="1.3")
